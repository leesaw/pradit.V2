...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
            <div class="col-md-8">
                <h3 class="page-header">ข้อมูลสินค้าออกจากสต็อก</h3>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
					...
					?>
						...
						<div class="row">
							<div class="col-md-3">
									<div class="form-group has-success">
                                            ...
                                            <input type="text" class="form-control" name="stockstatus" id="stockstatus" value="<?php 
											if ($loop->stockstatus == 1)   echo "ขายออก"; 
											elseif ($loop->stockstatus == 2)   echo "ย้ายคลัง"; 
											elseif ($loop->stockstatus == 3)   echo "เบิกใช้ซ่อม"; 
											elseif ($loop->stockstatus == 4)   echo "ของเคลม"; 
											elseif ($loop->stockstatus == 5)   echo "ของแถม"; 
						...
						<div class="row">
							<div class="col-md-5">
									<button type="button" class="btn btn-warning" onClick="window.location.href='<?php echo site_url("managestock/viewStockOUTSelectedCat/".$loop->categoryID); ?>'"> กลับไปหน้าประวัติสินค้าเข้าสต็อก </button>
							</div>
						</div>
