...
<div id="wrapper">
	...
	<?php $url = site_url("managepurchase/deletetemp_purchase_cash"); ?>
	
	
	<div id="page-wrapper">
		<div class="row">
            <div class="col-lg-8">
                <h3 class="page-header">Barcode สินค้าในใบซื้อเงินสด</h3>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <?php 
									echo form_open('managepurchase/saveBarcodeTemp_purchase_cash'); ?>
			...
			<div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<div class="row">
							<div class="col-lg-10">
									<a href="<?php echo site_url("managepurchase/showtemptopurchase_cash");  ?>"><button type="button" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-thumbs-up"></span>  ยืนยันรายการสินค้าทั้งหมด  </button></a>
									<button type="button" class="btn btn-danger btn-lg" onClick="window.location.href='<?php echo site_url("managepurchase/cleartemp/1"); ?>'"><span class="glyphicon glyphicon-repeat"></span> เริ่มต้นใหม่ทั้งหมด </button>
							</div>
						</div>
