			...
			<form method="post">
				<div class="col-lg-4">
					<div class="form-group">
						...
						<select class="form-control" name="branchid" id="branchid" onChange="this.form.action='<?php echo site_url('managepurchase/viewPurchaseByBranch')?>/'+this.value;this.form.submit()"> 
						<option value=""></option>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function()
    {
        ...
        ({
            ...
            'bServerSide'    : false,
            "bDeferRender": true,
            'sAjaxSource'    : '<?php echo site_url("managepurchase/ajaxGetStockHistoryPurchase/".$this->uri->segment(3)); ?>',
