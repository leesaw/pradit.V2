...
<div id="wrapper">
	...
	<?php $url = site_url("managepurchase/deletetemp_purchase"); ?>
	
	
	<div id="page-wrapper">
		<div class="row">
            <div class="col-lg-8">
                <h3 class="page-header">Barcode สินค้าในใบสั่งซื้อ</h3>
            </div>
        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <?php 
									echo form_open('managepurchase/saveBarcodeTemp_purchase'); ?>
